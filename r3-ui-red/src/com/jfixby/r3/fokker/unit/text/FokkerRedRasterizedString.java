...
import com.jfixby.r3.fokker.core.font.GdxR3FontCache;
import com.jfixby.r3.fokker.core.font.GdxR3FontGenerator;
import com.jfixby.r3.fokker.core.font.GdxR3FontParameters;
import com.jfixby.r3.fokker.core.font.RedBitmapFont;
...
public class FokkerRedRasterizedString implements FokkerDrawable, FokkerString, VisibleComponent {
	...
	public void doDraw () {
		...
		RenderMachine.component().beginRasterMode(UI_BLEND_MODE.GDX_DEFAULT, this.opacity);
		...
		RenderMachine.component().endRasterMode(UI_BLEND_MODE.GDX_DEFAULT);
