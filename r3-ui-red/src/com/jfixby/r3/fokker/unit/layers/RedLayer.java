...
public class RedLayer implements Layer, RootLayer {
	...
	public FastList<Object> listUnitKeyboardListeners () {
		return this.layer_children.listUnitKeyboardListeners();
	}

	public FastList<Object> listUnitMouseListeners () {
		return this.layer_children.listUnitMouseListeners();
	}
