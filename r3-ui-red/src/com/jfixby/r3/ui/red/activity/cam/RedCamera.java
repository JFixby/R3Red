...
import com.jfixby.r3.ui.api.activity.camera.CameraProjection;
...
import com.jfixby.r3.ui.red.activity.layers.ScreenDimentionsHolder;
...
// final Float2 camera_vieport_original_size = Geometry.newFloat2();
	...
	public RedCamera (final CameraSpecs cam_properties, final RedComponentsFactory redComponentsFactory) {
